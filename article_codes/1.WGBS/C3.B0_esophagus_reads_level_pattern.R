path <- "I:/Projects/P7.Methy-PanCancer/data_analysis/B0.esophagus_WGBS/Mehist/"
sampleID1 <- read.table("I:/Projects/P7.Methy-PanCancer/data_analysis/B0.esophagus_WGBS/B0.esopha_normal.txt",sep = "\t",header = F)
sampleID2 <- read.table("I:/Projects/P7.Methy-PanCancer/data_analysis/B0.esophagus_WGBS/B0.esopha_tumor.txt",sep = "\t",header = F)
...
for (idx in c("SRR9070211","SRR9070262","SRR9070215","SRR9070231","SRR9070200")){
  ...
  library(ggplot2)
  pdf(paste0("I:/Projects/P7.Methy-PanCancer/pics/Esophagus_WGBS/Esophagus_",idx,".Mehist.pdf"),height = 3,width = 6)
...
tumor.list <- c("SRR9070215","SRR9070231","SRR9070200")
...
sampleID1[order1[3],1]

counts_f <- counts[,c(order1[2],ncol(counts)-2,ncol(counts)-1,ncol(counts))]
cgiinfo <- read.table("I:/Projects/P7.Methy-PanCancer/data_analysis/B0.esophagus_WGBS/B0.esophagus.WGBS.diffcgi.info.txt",sep = "\t",header = T)
...
write.table(final.info,'I:/Projects/P7.Methy-PanCancer/data_analysis/B0.esophagus_WGBS/B0.esophagus_Examples.ReadsCounts.txt',
            sep = "\t",row.names = T,col.names = T,quote = F)
## compare tumor clusters
cluster1 <- c("SRR9070215","SRR9070195","SRR9070258","SRR9070205")
cluster2 <- c("SRR9070229","SRR9070238","SRR9070216","SRR9070254","SRR9070250","SRR9070236","SRR9070247","SRR9070231")
cluster3 <- c("SRR9070245","SRR9070225","SRR9070188","SRR9070200")
...
library(ggplot2)
pdf("I:/Projects/P7.Methy-PanCancer/pics/Esophagus_WGBS/Esophagus_RIN_boxplot.pdf",height = 6,width = 3)
