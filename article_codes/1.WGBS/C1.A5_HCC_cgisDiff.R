data <- read.table("I:/Projects/P7.Methy-PanCancer/data_analysis/A5.HCC_WGBS/A5.HCC_cgis_merged.bed",
                   sep = "\t",header = T)
x <- is.na.data.frame(data)
...
for (idx in 1:nrow(data_f)){
  me.normal <- as.numeric(data_f[idx,5:37])
  me.tumor <- as.numeric(data_f[idx,38:70])
...
write.table(out,"I:/Projects/P7.Methy-PanCancer/data_analysis/A5.HCC_WGBS/A5.HCC.WGBS.diffcgi.info.txt",
