surv <- read.table("Y:/4.basic_data/TCGA_PancanAtlas/methylation_cgiprobe/Survival_hypo/Hypo_survivalHRPvalue_table.txt",
                   sep = "\t",header = T)

lvs <- c("LIHC","BLCA","PCPG","UCEC","LUSC","SKCM","CESC","HNSC","READ","STAD","ESCA","SARC",
         "BRCA","GBM","COAD","KICH","LUAD","ACC", "CHOL",
         "PRAD", "LAML", "PAAD", "THYM", "KIRC", "KIRP", "THCA", "LGG")
show  <- NULL
...
pdf("I:/Projects/P7.Methy-PanCancer/pics/TCGA_hyposurvival_integrated_points.pdf",height = 2.5,width = 15)
