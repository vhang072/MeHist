...
path1 <- "Y:/4.basic_data/TCGA_PancanAtlas/methylation_L1/CellLines/_L1Probe_450_allprobe_split_"
path2 <- "Y:/4.basic_data/TCGA_PancanAtlas/methylation_L1/"
...
for (x in used_lines){
  ...
  write.table(merged,
              paste0("Y:/4.basic_data/TCGA_PancanAtlas/methylation_L1/Diff_CCLE/_DiffL1probe_",celltypes[x],".txt"),
