...
path1 <- "Y:/4.basic_data/TCGA_PancanAtlas/methylation_cgiprobe/CellLines/_cgiProbe_450_allprobe_split_"
path2 <- "Y:/4.basic_data/TCGA_PancanAtlas/methylation_cgiprobe/"
...
for (x in used_lines){
  ...
  write.table(merged,
              paste0("Y:/4.basic_data/TCGA_PancanAtlas/methylation_cgiprobe/Diff_CCLE/_DiffCGIprobe_",celltypes[x],".txt"),
