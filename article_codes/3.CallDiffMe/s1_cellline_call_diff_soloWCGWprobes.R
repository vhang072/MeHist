...
prefix_file <- "_PMDsoloWCGWProbe_"
...
path1 <- "Y:/4.basic_data/TCGA_PancanAtlas/methylation_soloWCGW/CellLines/_PMDsoloWCGWProbe_450_allprobe_split_"
path2 <- "Y:/4.basic_data/TCGA_PancanAtlas/methylation_soloWCGW/"
...
for (x in used_lines){
  ...
  write.table(merged,
              paste0("Y:/4.basic_data/TCGA_PancanAtlas/methylation_soloWCGW/Diff_CCLE/_DiffsoloWCGWprobe_",celltypes[x],".txt"),
