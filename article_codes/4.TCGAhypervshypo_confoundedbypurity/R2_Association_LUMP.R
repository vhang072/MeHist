...
library(paletteer)
pdf("I:/Projects/P7.Methy-PanCancer/pics/tcga_purity_pertumor/meanval_corr_items_lump.pdf",height = 5.3,width = 7)
...
library(paletteer)
pdf("I:/Projects/P7.Methy-PanCancer/pics/tcga_purity_pertumor/num_corr_items_lump.pdf",height = 5.3,width = 7)
