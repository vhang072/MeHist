...
library(paletteer)
pdf("I:/Projects/P7.Methy-PanCancer/pics/tcga_purity_pertumor/meanval_corr_items_absolute.pdf",height = 7,width = 7)
...
library(paletteer)
pdf("I:/Projects/P7.Methy-PanCancer/pics/tcga_purity_pertumor/num_corr_items_absolute.pdf",height = 7,width = 7)
